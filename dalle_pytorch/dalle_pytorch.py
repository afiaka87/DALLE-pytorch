...
class CLIP(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.text_transformer = Transformer(causal = False, seq_len = text_seq_len, dim = dim_text, depth = text_enc_depth, heads = text_heads, attn_types = None, sparse_attn = False)
        ...
        self.visual_transformer = Transformer(causal = False, seq_len = num_patches, dim = dim_image, depth = visual_enc_depth, heads = visual_heads, attn_types = None, sparse_attn = False)
